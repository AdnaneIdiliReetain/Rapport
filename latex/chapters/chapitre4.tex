...
\standardfigure{images/AMIgo - CRM Archi High Level (16).png}{Diagramme de flux de données entre Cegid Y2, Shopify et Salesforce}{fig:data_flow_diagram}
...
\inlinefigure{images/AMIgo - CRM Archi High Level (13).png}{Flux du processus ETL pour le chargement des données}{fig:etl_process_flow}
...
\begin{itemize}
    \item \textbf{Cegid Y2 $\rightarrow$ Salesforce} : Synchronisation en temps réel des achats en boutique
    \item \textbf{Shopify $\rightarrow$ Salesforce} : Intégration des commandes e-commerce via webhooks
    \item \textbf{Salesforce $\rightarrow$ Cegid Y2} : Enrichissement des profils clients en boutique
    \item \textbf{Salesforce $\rightarrow$ Shopify} : Mise à jour des préférences et consentements
\end{itemize}
\end{mdframed}
